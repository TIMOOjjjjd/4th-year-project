...
Although the current design still leaves room for stronger graph validation, explicit edge weighting, and more systematic online adaptation, it already provides a solid and research-oriented methodological foundation. It is not merely a collection of implementation choices. Rather, it is a structured response to the combined challenges of temporal complexity, spatial dependence, uncertainty, and operational realism in urban taxi demand forecasting.
	...
	\subsection{Experiment 1: Temporal Baseline Comparison}
	...
	\subsection{Experiment 2: Effect of Graph-based Residual Refinement}
...
\end{table}
	...
	\subsection{Experiment 3: Confidence-weighted GNN Ablation}
	...
	\subsection{Experiment 4: Incremental Training in Rolling Forecasting}
	...
	\[
	\text{Multi-scale Temporal Prediction}
	\rightarrow
	\text{GraphSAGE Residual Refinement}
	\rightarrow
	\text{Confidence-weighted Robustness}
	\rightarrow
	\text{Incremental Rolling Adaptation}.
	\]
	...
	\subsection{Interpretation of the Multi-scale Temporal Model}
	...
	\subsection{Interpretation of Graph-based Residual Refinement}
	...
	\subsection{Interpretation of Confidence Weighting}
	...
	\subsection{Interpretation of Incremental Training}
	...
	\begin{figure}[h]
		\centering
		\includegraphics[width=1\textwidth]{img/7.1.png}
		\caption{Stage-wise structure of the proposed rolling taxi-demand forecasting framework, progressing from multi-scale temporal prediction to GraphSAGE residual refinement, confidence-weighted learning, and incremental rolling adaptation.}
		\label{fig:7.1}
	\end{figure}
	
	
	This modular structure is one of the main strengths of the work. It allows each component to be analysed, improved, and replaced independently. For example, the temporal backbone could be changed without redesigning the graph refinement module, and the GraphSAGE component could be replaced by another graph neural network architecture in future work.

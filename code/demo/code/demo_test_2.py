"""Experiment 1 runner for PatchTST and DLinear temporal backends.

Default run:
    python code/demo_test_2.py

This keeps demo_test.py's seed and rolling-window configuration, but only
evaluates PatchTST and DLinear. Outputs are written to a separate directory so
the full Experiment 1 summary is not overwritten.
"""
...
DEFAULT_RESULTS_DIR = BASE_DIR / "ex_1_result_patchtst_dlinear"
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        ...
        help="Backends to run sequentially. Default runs PatchTST and DLinear.",
    )
    parser.add_argument(
        "--window-starts",
        nargs="*",
